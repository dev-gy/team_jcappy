...
<meta charset="UTF-8">
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
 	<script src="/jcappy/js/mypage_ordercanceldetail.js"></script>
    <link rel="stylesheet" href="/jcappy/css/reset.css">
    <link rel="stylesheet" href="/jcappy/css/mypage_ordercanceldetail.css">
</head>
...
<body>
    ...
    <div class="mypage_wrap">
        ...
        <div id="content">
            <!-- 서브메뉴 타이틀 -->
            <div class="subheader">
                <p class="subtitle">취소/교환/반품 정보</p>
            </div>
            <!-- 서브메뉴 본문 -->
            <!-- 취소/교환/반품 정보 -->
            <div>
