    ...
    <div id="wrap">
        ...
        <div id="container">
            <div class="policy_content">
                ...
                <button class="cstyle_btn ex" type="button" id="continue" onclick="location.href='/jcappy/join.do'" disabled>가입하기</button>
                <button class="cstyle_btn ex" type="button" onclick="location.href='/jcappy/index.do'" >취소하기</button>
            </div>
        </div>
