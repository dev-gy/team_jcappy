							...
							<c:if test="${empty daySelect}">
								<div class='page'>
			                        ...
			                        <c:if test="${salesVo.reqPage == rp }">
										<span><a href='index?reqPage=${rp}&year=${param.year}&month=${param.month}&datepicker=${param.datepicker}'><strong>${rp }</strong></a></span>
			                        </c:if>
			                        <c:if test="${salesVo.reqPage != rp }">
			                            <span><a href='index?reqPage=${rp}&year=${param.year}&month=${param.month}&datepicker=${param.datepicker}'>${rp }</a></span>
			                        </c:if>
			                        </c:forEach>
